...
const SPECIAL_HINTS = {
  CHAOS: "Starts with C. Total disorder; the group chat with Wi-Fi.",
  FERAL: "Starts with F. Wild or untamed; civilized plans have left.",
  PETTY: "Starts with P. Small-minded revenge, usually over something tiny.",
  SALTY: "Starts with S. Bitter or annoyed, with snack seasoning energy.",
  TOXIC: "Starts with T. Harmful vibes; bad for plants and relationships.",
  TIPSY: "Starts with T. Slightly drunk, not yet fully sideways.",
  VODKA: "Starts with V. Clear liquor; brunch decision-making solvent.",
  TWERK: "Starts with T. A butt-first dance move.",
  DRAMA: "Starts with D. Conflict, spectacle, and unnecessary plot.",
  PANIC: "Starts with P. Sudden fear; brain hitting every elevator button.",
  SWEAT: "Starts with S. Nervous or workout moisture.",
  CURSE: "Starts with C. A swear, spell, or very directed bad wish.",
  HEXED: "Starts with H. Put under a spell; vibes officially cursed.",
  COVEN: "Starts with C. A group of witches; meeting minutes optional.",
  OUIJA: "Starts with O. Spirit-board brand; haunted customer support.",
  CRYPT: "Starts with C. Underground tomb; basement with lore.",
  RABID: "Starts with R. Wildly intense or infected with rabies.",
  MANIC: "Starts with M. Frantic, overexcited, running on sparks.",
  MOODY: "Starts with M. Emotionally cloudy with a chance of side-eye.",
  SPITE: "Starts with S. Doing it because revenge said please.",
  SAUCY: "Starts with S. Bold, cheeky, or a little flirtatious.",
  SNARK: "Starts with S. Sarcastic attitude in sentence form.",
  WRECK: "Starts with W. A ruined thing, plan, or person after screenshots.",
  CRASH: "Starts with C. Smash, fail, or suddenly fall asleep.",
  VEXED: "Starts with V. Annoyed, irritated, officially bothered.",
  JUICY: "Starts with J. Full of liquid, gossip, or scandal.",
  MESSY: "Starts with M. Untidy, chaotic, and probably entertaining.",
  GRIFT: "Starts with G. A scam or shady hustle.",
  YIKES: "Starts with Y. What you say when the vibes trip.",
  WOOZY: "Starts with W. Dizzy, faint, or carousel-brained.",
  SHADY: "Starts with S. Suspicious, sly, or not telling the whole story.",
  CRAVE: "Starts with C. Want badly, usually snacks or attention.",
  WORST: "Starts with W. The opposite of best; friendship insult classic.",
  ROAST: "Starts with R. Cook with dry heat, or insult with affection.",
  GUILT: "Starts with G. Bad-feeling debt from doing something wrong.",
  SHAME: "Starts with S. Embarrassed regret, but heavier.",
  DOOMY: "Starts with D. Gloomy in an end-times way.",
  ZESTY: "Starts with Z. Lively, spicy, citrusy, too much personality.",
  SASSY: "Starts with S. Boldly cheeky; mouth got there first.",
  HAZED: "Starts with H. Foggy, dazed, or put through initiation nonsense.",
  RAGER: "Starts with R. A wild party; floors may regret it.",
  FROTH: "Starts with F. Foam on top, usually from agitation.",
  SNEER: "Starts with S. A contempt face, mostly lip-based.",
  SNIDE: "Starts with S. Mean in a sly, sideways way.",
  BRASH: "Starts with B. Loudly confident, subtlety unavailable.",
  WEIRD: "Starts with W. Strange, odd, delightfully off-normal.",
  AWFUL: "Starts with A. Very bad; disaster with branding.",
  PISSY: "Starts with P. Irritable and cranky, tiny storm mode.",
  BOOZY: "Starts with B. Alcohol-heavy; brunch has consequences.",
  GRUMP: "Starts with G. A cranky person or mood.",
  ZONED: "Starts with Z. Spaced out; mentally buffering.",
  HYPED: "Starts with H. Very excited, maybe over-caffeinated.",
  LURID: "Starts with L. Shocking, vivid, or scandal-colored.",
  BITCH: "Starts with B. A harsh complaint or insult; spicy noun.",
  FUCKS: "Starts with F. Things one may dramatically not give.",
  SHITS: "Starts with S. Things one may also not give.",
  DILDO: "Starts with D. A sex toy; drawer lore.",
  BOOBS: "Starts with B. Informal word for breasts.",
  BONER: "Starts with B. Slang for an erection or a dumb mistake.",
  KINKY: "Starts with K. Sexually unconventional, or tightly twisted.",
  PERVY: "Starts with P. Creepy in a sexual way.",
  HORNY: "Starts with H. Sexually turned on; brain has bad manners.",
};

const HINT_VIBES = [
  "Starts with {first}, ends with {last}. Common English word.",
  "Starts with {first}, ends with {last}. Has {vowels} vowel sound(s).",
  "Starts with {first}, ends with {last}. Dictionary word, not slang.",
  "Starts with {first}, ends with {last}. The boring clue wore good shoes.",
  "Starts with {first}, ends with {last}. Think real word, not pure chaos.",
  "Starts with {first}, ends with {last}. Has {vowels} vowel sound(s), allegedly.",
];
...
function hintForWord(word) {
  ...
  return HINT_VIBES[seed % HINT_VIBES.length]
    .replace("{first}", word[0])
    .replace("{last}", word[word.length - 1])
    .replace("{vowels}", String(vowels));
}
